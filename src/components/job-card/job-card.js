    ...
    return (
        <li className="job-card">
            <div className="job-card__head">
                ...
                <p className="job-card__level">Required level: <span className="job-card__level-span">Middle</span></p>
            ...
            <div className="job-card__body">
                <div className="job-card__body-info">
                    <p className="job-card__body-text">Experienced designer required to make updates to website graphic assets and email banner. Files will be provided in Adobe illustrator and Photoshop PSD. Tasks as follows: ...</p>
                    <img
